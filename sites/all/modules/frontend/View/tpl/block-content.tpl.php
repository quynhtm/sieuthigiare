					...
					<li class="item">
						<div class="post-thumb">
							...
							<a href="<?php echo FunctionLib::buildLinkDetail($item->product_id, $item->product_name); ?>" title="<?php echo $item->product_name?><?php echo ' - '.WEB_SITE ?>">
								...
								<img src="<?php echo ThumbImg::thumbBaseNormal(FOLDER_PRODUCT, $item->product_id, $item->product_image, 300, 400, '', true, true) ?>"
								data-other-src="<?php echo ThumbImg::thumbBaseNormal(FOLDER_PRODUCT, $item->product_id, $item->product_image_hover, 300, 400, '', true, true) ?>"
