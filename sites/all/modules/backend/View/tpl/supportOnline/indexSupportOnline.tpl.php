	...
	<div class="page-title-box">
		<div class="wrapper">
			<h5><?php
				...
				?></h5>
			<span class="tools">
				<a href="<?php echo $base_url; ?>/admincp/supportonline/add" class="icon-plus" title="Add"></a>
                <a href="javascript:void(0)" id="deleteMoreItem" class="icon-remove" title="Delete" ></a>
           </span>
		</div>
	</div>
