	...
	<div class="wrapp-search-box">
		...
		<form action="" method="GET" id="frmSearch" class="frmSearch" name="frmSearch">
			<div class="col-lg-3">
				...
				<div><input type="text" class="form-control input-sm" placeholder ="Tiêu đề bài viết" id="news_title" class="keyword" name="category_name" value="<?php echo $dataSearch['news_title'] ?>"/></div>
			</div>
			...
			<div class="showListItem">
				<table class="table taicon-adminble-bordered table-hover table-striped" width="100%" cellpadding="5" cellspacing="1" border="1">
					...
					<tr>
						...
						<th width="8%" class="td_list">Loại tin</th>
						<th width="8%" class="td_list">Thuộc danh mục</th>
